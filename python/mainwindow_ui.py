...
"}")
        ...
        self.gridLayout_4.addWidget(self.controlBar, 1, 1, 1, 1)
        ...
        self.filelistArea.setStyleSheet("")
...
"")
        ...
        self.gridLayout_4.addWidget(self.filelistArea, 2, 1, 1, 1)
...
"}")
        ...
        self.gridLayout_4.addWidget(self.notificationArea, 3, 1, 1, 1)
...
"}")
        ...
        item.setFont(font)
        self.sidebar.addItem(item)
        self.gridLayout_4.addWidget(self.sidebar, 1, 0, 3, 1)
